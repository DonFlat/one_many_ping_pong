...
def main():
    ...
    if args.network_mode == 'ib':
        base_command = "prun -np {node_num} -1 -script $PRUN_ETC/prun-openmpi `pwd`/"
        ...
        base_command = "prun -np {node_num} -1 OMPI_OPTS=\"--mca btl tcp,self --mca btl_tcp_if_include ib0\" -script $PRUN_ETC/prun-openmpi `pwd`/"
